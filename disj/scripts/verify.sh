...
cat $path_tmp_cfg | $dir_parser"/parser" -t 4 -p 1 -o $dir_temp"/"$file_c1_verif
cat $path_tmp_cfg | $dir_parser"/parser" -t 4 -p 2 -o $dir_temp"/"$file_c2_verif
cat $path_tmp_cfg | $dir_parser"/parser" -t 4 -p 3 -o $dir_temp"/"$file_c3_verif
